...
export const FloatingTotal = ({ 
  ...
  return (
    <>
      <div className="sticky top-0 left-0 right-0 z-[100] pointer-events-none">
        <div className="fixed top-4 right-4 pointer-events-auto bg-[#8B5CF6] shadow-lg rounded-lg p-4 animate-float-in text-white">

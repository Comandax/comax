...
export const OrderSummaryModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-3xl w-[95%] md:w-full max-h-[90vh] overflow-y-auto p-4 md:p-6" onOpenAutoFocus={(e) => e.preventDefault()}>
        <DialogHeader>
                  ...
                  {items.map((item) => {
                    ...
                    return (
                      <TableRow key={item.productId}>
                        ...
                        <TableCell className="text-sm max-w-[120px] md:max-w-none break-words">{item.name}</TableCell>

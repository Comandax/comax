  ...
  return (
    <Alert className="mb-6" variant="default">
      ...
      <AlertDescription>
        ...
        Por esse motivo, você está recebendo <strong className="text-primary">um mês grátis</strong> para utilizar a plataforma e, após esse período, terá <strong className="text-primary">10% de desconto</strong> na mensalidade para sempre!
      </AlertDescription>
    </Alert>
  );
}
